...
class CustomRender(
    ...
    private val glWidth: Double,
    private val glHeight: Double,
) {
...
//            ThreeEgl.setContext("shareContext", shareEglEnv!!.eglContext)
        ...
        entry.surfaceTexture().setDefaultBufferSize(glWidth.toInt(), glHeight.toInt())
...
//            dartEglEnv!!.buildOffScreenSurface(glWidth.toInt(), glHeight.toInt())
//        }
    }
